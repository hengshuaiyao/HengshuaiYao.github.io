...
Thus our conclusion is, **the class interference is the bottleneck of deep learning**. It represents learning difficulty regarding similar classes in the data. This is a challenging task for human beings as well. Eyeing cross images samples in CIFAR-10, we found some cats are even hard to tell apart from DOG. 
