...
To students who want to work with me: I'm sorry. I just couldn't take any student because I moved to Sony AI.   
...
We also had one phone conversation and lots of email discussions before their NIPS 2008 submssion. I did experiments for GTD and wrote a two-page PDF to point out (1) two time-scale formulation of GTD is slow; (2) the two step-sizes are not easy to use. Someone also asked me to send the Boyan chain example code to his student. Later on, the TDC paper's Boyan chain experiment was based on my code. In my experiment, I used on-policy learning to study the convergence rate of off-policy learning algorithms. This is the first time in literature, and it was adopted in all the experiments of the TDC paper.  
...
ETD: Equation 13 of the [ETD paper](https://arxiv.org/pdf/1503.04269.pdf) is just the PageRank formulation. Later the ETD authors started using some vector called "user interest" vector. It is just the personalized PageRank. It was a commonplace form in the PageRank literature, but it was treated so new in RL because the ETD paper did not mention anything about this background. My [reinforcement ranking paper](papers/rr.pdf) is the first paper that points out the connection between reinforcement learning and the PageRank literature. Someone was in my defense committee when I did my candidacy based on this reverse Bellman equation, and he abondoned me (an internaltional student at the time) as my Ph.D supervisor when I wanted to purse this direction in 2011. Unfortunately, the person, who I highly respected for so many years, just said "No" when my new supervisor arranged my defense in 2014 and asked him whether he wanted to be part of it.
It's Okay in a normal situation. People have different interests and schedules. It's just so heartbroken to hear that after I knew well what he did to me for all these, amongst I worked with him for three years in my Ph.D time. 
...
I also deeply appreciate Rich at heart. His TD paper stimulated the first interests in a baby student. I was following some reference in the world Robocup simulation community and found TD. His linear Dyna is still influencing my mind today. 
