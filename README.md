...
I had wished for the authors of the GTD, TDC/GTD2 papers to have a reflection (e.g., search  the email boxes?) on (1) whether the GTD and TDC papers took great advantage of the preconditioning paper without giving any credit, and (2) whether my involvement at the time deserved the authorship. I patiently waited I guess. Is 15 years still not enough for someone to rethink about it? There hasn't been a single kind gesture from someone who did this. How many 15 years does one have in one's research career?
