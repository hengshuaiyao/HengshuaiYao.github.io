...
I don't know if anyone has the same observation and concern with me. I recently submitted to a conference that I never did. The conference is a top and famous one. By accident, after submission, I found someone has 20+ papers in this conference, a single year. This guy also serves an important position at this conference and community. Some of this author's paper are also on arxiv. A few years ago, I also some famous author has 13 papers on ICRA, one year. It is not uncommon these days. Here is what we have: "fame/positions + lab/network scale + arxiv + this review process". 
