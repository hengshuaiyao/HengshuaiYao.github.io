...
I had wished (and patiently waited) for the authors of the GTD, TDC/GTD2 papers to have a reflection (e.g., search  the email boxes?) on, 

- **whether the GTD and TDC papers took great advantage of the preconditioning paper without giving any credit**; 
- **whether my involvement at the time deserved the authorship**. 
