...
- [Preconditioned temporal difference learning](papers/ptd.pdf). Yao, H., and Liu, Z-Q. ICML, Helsinki, Finland. June 2008. I appreciate the three reviewers (who all acceptted in the first review round) and all the reviewers who had spent their time reading this paper and given valuable feedbacks. 
...
Gradient TD stands for a unique way of conducting off-policy with linear function approximation, forming an important class of modern reinforcement learning algorithms. If you have worked on, read or cited GTD, TDC, GTD2, GQ, and Horde, perhaps you should read this paper on where the NEU objective function (defined in the TDC paper) and the idea of GTD was from. This paper is also the first to use "Grad TD" (shorthand in the figure). 
