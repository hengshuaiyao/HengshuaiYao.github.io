...
However, my contributions were not recognized or credited by the literature for some reason. These two papers received about 1000+ citations at the time of writing this. My paper received 13. None of the GTD and TDC citations referred to my paper for the source of GTD and GTD2/TDC ideas. I was also involved in the GTD discussions and a part of the TDC paper development. However, for some reason my name was not there. I wish the GTD and the GTD2/TDC authors can read my preconditioning TD paper and [compare with yours](gtd_novelty.md). Some authors please kindly have a reflection (e.g., search  your email boxes) on, **(1) whether the GTD and TDC papers took great advantage of the preconditioning paper without giving any credit; (2) whether my involvement at the time deserved the authorship**. Some authors agreed to give future credits when they will write on the topic. If you cite GTD and the GTD2/TDC papers in your research, please consider giving the preconditioning paper a kind credit.
