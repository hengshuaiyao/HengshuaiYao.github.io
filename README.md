...
If you have worked on, read or cited GTD, TDC, GTD2, GQ, and Horde, perhaps you should read this paper on where the NEU objective function (defined in the TDC paper) and the idea of GTD is from.   
