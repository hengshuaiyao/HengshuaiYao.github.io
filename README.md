...
Unfortunately, these three works were not independent. We had a phone conversation (for a Ph.D candidate interview in March 2008) and lots of email discussions before their NIPS 2008 submssion. I did experiments for GTD and compared GTD with TD. I wrote a two-page PDF, in which I pointed out (1) two time-scale formulation of GTD is slow; (2) the two step-sizes are not easy to use. Read the conclusion of the GTD paper to have a sense of the tone change from "ground breaking" to "practicality". Someone also asked me to send the Boyan chain example code to his other student. Later on, the TDC paper's Boyan chain experiment was based on my code. In my experiment, I used on-policy learning to study the convergence rate of off-policy learning algorithms. This was the first time in literature to use this experimentation method (e.g., read the importance sampling off-policy TD papers By Sutton, et. al. in 2000 and 2001 to see their experimentation method). This experimentation method was adopted in all the experiments of the TDC paper. Later research (e.g., see [TDRC](https://arxiv.org/pdf/2007.00611.pdf)) uses this method as a standard way to study off-policy learning algorithms. 

I had wished (and patiently waited) for the authors of the GTD, TDC/GTD2 papers to have a reflection (e.g., search  the email boxes?) on (1) whether the GTD and TDC papers took great advantage of the preconditioning paper without giving any credit, and (2) whether my involvement at the time deserved the authorship. 
...
The amount of ...confusion... is something I've never experienced... It's revisiting and chronic. Given the number of years for the discussed matters, one should have a faith in my mental efforts to bypass it. I started mentoring students in recent years, which gave me a different perspective of looking at things. I can see students are so young, vibrant and creative. What are we there for, as supervisors and mentors in academic (and industry)? I've worked for a few companies. All them spent a great deal of efforts in educating us the "ethics", in doing work and business. Academics have well defined student code conduct. By default, professors and senior persons should have built this into our mind and behaviors. We work by trust and ethics. This is the value of our academic research, and the foundation of our reviewing system, which should always be practised and glorified.        
