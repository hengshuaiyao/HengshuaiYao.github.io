...
Gradient TD stands for a unique way of conducting off-policy with linear function approximation. If you have worked on, read or cited GTD, TDC, GTD2, GQ, and Horde, perhaps you should read this paper on where the NEU objective function (defined in the TDC paper) and the idea of GTD is from.   

<div align="center">
<img align="center" src="papers/gtd_side_by_side.png" alt="hi" class="inline"/>
</div>

This figure from the preconditioning paper in fact shows that GTD is slow (before GTD was even submitted). MR is the faster
