...
I don't know if anyone else has the same observation and concern with me. I recently submitted to a conference that I never did. The conference is a top and famous one. By accident, after submission, I found someone has 20+ papers in this conference, a single year. This guy also serves the important position at this conference and community. Some of this author's paper are also on arxiv. 
